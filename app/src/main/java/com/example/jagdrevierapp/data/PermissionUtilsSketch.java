...
public abstract class PermissionUtilsSketch {
     ...
     */
    public static void requestPermission(RevierSketch activity, int requestId,
    ...
    public static class PermissionDeniedDialog extends DialogFragment {
         ...
         */
        public static PermissionUtils.PermissionDeniedDialog newInstance(boolean finishActivity) {
            Bundle arguments = new Bundle();
            arguments.putBoolean(ARGUMENT_FINISH_ACTIVITY, finishActivity);

            PermissionUtils.PermissionDeniedDialog dialog = new PermissionUtils.PermissionDeniedDialog();
